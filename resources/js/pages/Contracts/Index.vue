...
const {
    ...
    data: contracts,
    error,
} = useFetch('/api/contracts').get().json();
...
<template>
    ...
    <div
        class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl bg-gray-50/50 p-4 md:p-6 dark:bg-transparent"
    >
        <div class="mb-2 flex items-center justify-between">
            <div>
                ...
                >
                    Aperçu de vos contrats
                </h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Consultez et analysez vos différents contrats d'énergies
                    actifs.
                </p>
            </div>
        </div>
        ...
        >
            <div
                class="h-10 w-10 flex-shrink-0 animate-spin rounded-full border-t-2 border-b-2 border-primary"
            ></div>
        ...
        >
            <div class="flex">
                <p class="text-sm font-medium text-red-800 dark:text-red-200">
                    Nous n'avons pas pu charger vos contrats. Vérifiez votre
                    connexion.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            "
            class="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 p-12 dark:border-sidebar-border"
        >
            <h3
            ...
            <p class="mt-1 max-w-sm text-center text-sm text-gray-500">
                Vous n'avez pas encore de contrat actif enregistré sur la
                plateforme Espace Client Éco.
            </p>
        </div>
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            <div
                ...
                :key="contract.id"
                class="group flex flex-col overflow-hidden rounded-2xl border border-gray-200/60 bg-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-md dark:border-sidebar-border dark:bg-[#1a1c23]"
            >
                <!-- En-tête de Carte -->
                <div
                    class="border-b border-gray-100 px-6 py-5 dark:border-white/5"
                >
                    ...
                    <div
                        class="mt-4 flex gap-6 text-sm text-gray-500 dark:text-gray-400"
                    >
                ...
                <div class="p-6">
                    <h4
                        class="mb-4 text-sm font-medium text-gray-900 dark:text-gray-200"
                    >
